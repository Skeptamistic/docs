...
To continue the example, the client requests quantity information for the Prosecco drink, the last in the response of the previous step. The last essential ingredient in the Prosecco has the `ingredient_id` equal to `685895df7e453310d06b15e8`.
...
```bash
curl -X 'GET' \
  'https://{server url}/ingredients/685895df7e453310d06b15e8?fields=in_stock_qty%7Cname'
```
