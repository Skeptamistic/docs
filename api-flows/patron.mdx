...
The patron flow has six steps. The patron does not have to furnish credentials for authentication or authorization for any of the steps.
...
curl -X 'POST' \
  ...
  -H 'Authorization: Bearer e98c7c18-562f-48f3-b241-2a8a8e83693c' \
